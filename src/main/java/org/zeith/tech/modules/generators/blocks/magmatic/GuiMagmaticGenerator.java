...
public class GuiMagmaticGenerator
		extends GuiBaseMachine<ContainerMagmaticGenerator>
{
	public GuiMagmaticGenerator(ContainerMagmaticGenerator container, Inventory plyerInv, Component name)
	{
	...
	{
		menu.tile.storage.setFluid(menu.tile.storageSmooth.getClientAverage(minecraft.getPartialTick()));
		menu.tile.coolant.setFluid(menu.tile.coolantSmooth.getClientAverage(minecraft.getPartialTick()));
		
		FXUtils.bindTexture(ZeithTech.MOD_ID, "textures/generators/gui/magmatic_generator.png");
