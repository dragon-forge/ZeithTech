...
public class ContainerMagmaticGenerator
		extends ContainerBaseMachine<TileMagmaticGenerator>
{
	protected ContainerMagmaticGenerator(TileMagmaticGenerator tile, Player player, int windowId)
	{
		...
		this.addSlot(new FluidSlotBase.FluidTankSlot(tile.coolant, 123, 16));
	}
	...
	{
		return new GuiMagmaticGenerator(this, inv, label);
	}
