...
public class TileRendererMachineAssemblerA
		implements IBESR<TileMachineAssemblerA>
{
	@Override
	public void render(TileMachineAssemblerA entity, float partial, PoseStack matrix, MultiBufferSource buf, int lighting, int overlay)
	{
		var mc = Minecraft.getInstance();
		var ir = mc.getItemRenderer();
		
		RotatedRenderHelper.rotateHorizontalPoseStack(matrix, entity.getBlockState().getValue(BlockStateProperties.HORIZONTAL_FACING), 0.5F, 0.9375F, 0.44F);
