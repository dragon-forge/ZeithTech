...
public class GuiFacadeSlicer
		extends GuiBaseMachine<ContainerFacadeSlicer>
{
	public GuiFacadeSlicer(ContainerFacadeSlicer container, Inventory plyerInv, Component name)
	{
	...
	protected void renderBackground(PoseStack pose, float partialTime, int mouseX, int mouseY)
	{
		...
		{
			float progress = tile._progress / (float) tile._maxProgress;
