...
public class ContainerMetalPress
		extends ContainerBaseMachine<TileMetalPress>
{
	public ContainerMetalPress(TileMetalPress tile, Player player, int windowId)
	{
	...
	@Override
	@OnlyIn(Dist.CLIENT)
	public GuiMetalPress openScreen(Inventory inv, Component label)
	{
		return new GuiMetalPress(this, inv, label);
	}
