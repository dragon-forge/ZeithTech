		...
		implements IRegisterListener, ICustomBlockItem
{
	...
	public BlockHeveaSlab(Properties props)
	{
		super(props);
	}
	
	public BlockHeveaSlab dropsSelf()
	{
		this.dropsSelf = true;
		return this;
	}
	
	public BlockHeveaSlab addItemTags(Collection<TagKey<Item>> tags)
	{
		if(itemBlock != null)
			for(var tag : tags)
