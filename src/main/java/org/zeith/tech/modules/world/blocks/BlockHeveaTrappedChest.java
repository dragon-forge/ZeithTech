...
public class BlockHeveaTrappedChest
		extends BlockHeveaChest
{
	public BlockHeveaTrappedChest(Properties props, Supplier<BlockEntityType<? extends ChestBlockEntity>> type)
	{
		super(props, type);
	}
