		...
		extends CommonWorldProxyZT
{
	...
	private void registerLayerDefinition(EntityRenderersEvent.RegisterLayerDefinitions e)
	{
		...
		{
			e.registerLayerDefinition(BoatZTRenderer.createBoatModelName(type), BoatModel::createBodyModel);
			e.registerLayerDefinition(BoatZTRenderer.createChestBoatModelName(type), ChestBoatModel::createBodyModel);
		}
	}
