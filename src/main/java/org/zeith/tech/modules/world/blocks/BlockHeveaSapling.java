...
public class BlockHeveaSapling
		...
		implements IRegisterListener, ICustomBlockItem
{
	...
	public BlockHeveaSapling(AbstractTreeGrower grower, Properties props)
	{
		super(grower, props);
	}
	
	public BlockHeveaSapling dropsSelf()
	{
		this.dropsSelf = true;
		return this;
	}
	
	public BlockHeveaSapling addItemTags(Collection<TagKey<Item>> tags)
	{
		if(itemBlock != null)
			for(var tag : tags)
	...
	public BlockHeveaSapling addItemTag(TagKey<Item> tag)
	{
		if(itemBlock != null)
			TagAdapter.bindStaticTag(tag, itemBlock);
		itemTags.add(tag);
	...
	public BlockHeveaSapling addBlockTags(Collection<TagKey<Block>> tags)
	{
		for(var tag : tags)
	...
	public BlockHeveaSapling addBlockTag(TagKey<Block> tag)
	{
		TagAdapter.bindStaticTag(tag, this);
		return this;
	}
