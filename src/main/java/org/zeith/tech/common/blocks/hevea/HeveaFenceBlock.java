		...
		implements IRegisterListener, ICustomBlockItem
{
	...
	public HeveaFenceBlock(Properties props)
	{
		super(props);
	}
	
	public HeveaFenceBlock dropsSelf()
	{
		this.dropsSelf = true;
		return this;
	}
	
	public HeveaFenceBlock addItemTags(Collection<TagKey<Item>> tags)
	{
		if(itemBlock != null)
			for(var tag : tags)
	...
	public HeveaFenceBlock addItemTag(TagKey<Item> tag)
	{
		if(itemBlock != null)
			TagAdapter.bindStaticTag(tag, itemBlock);
		itemTags.add(tag);
	...
	public HeveaFenceBlock addBlockTags(Collection<TagKey<Block>> tags)
	{
		for(var tag : tags)
	...
	public HeveaFenceBlock addBlockTag(TagKey<Block> tag)
	{
		TagAdapter.bindStaticTag(tag, this);
		return this;
	}
