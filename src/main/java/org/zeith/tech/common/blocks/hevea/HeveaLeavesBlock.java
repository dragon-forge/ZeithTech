...
public class HeveaLeavesBlock
		extends LeavesBlock
		implements IRegisterListener, ICustomBlockItem
{
	private final List<TagKey<Item>> itemTags = new ArrayList<>();
	
	public HeveaLeavesBlock(BlockBehaviour.Properties props)
	{
		super(props);
	}
	
	public HeveaLeavesBlock addItemTags(Collection<TagKey<Item>> tags)
	{
		for(var tag : tags)
		{
			if(itemBlock != null)
	...
	public HeveaLeavesBlock addBlockTags(Collection<TagKey<Block>> tags)
	{
		for(var tag : tags)
