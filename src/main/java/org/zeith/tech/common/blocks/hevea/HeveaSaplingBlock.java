...
public class HeveaSaplingBlock
		...
		implements IRegisterListener, ICustomBlockItem
{
	...
	public HeveaSaplingBlock(AbstractTreeGrower grower, Properties props)
	{
		super(grower, props);
	}
	
	public HeveaSaplingBlock dropsSelf()
	{
		this.dropsSelf = true;
		return this;
	}
	
	public HeveaSaplingBlock addItemTags(Collection<TagKey<Item>> tags)
	{
		if(itemBlock != null)
			for(var tag : tags)
	...
	public HeveaSaplingBlock addItemTag(TagKey<Item> tag)
	{
		if(itemBlock != null)
			TagAdapter.bindStaticTag(tag, itemBlock);
		itemTags.add(tag);
	...
	public HeveaSaplingBlock addBlockTags(Collection<TagKey<Block>> tags)
	{
		for(var tag : tags)
	...
	public HeveaSaplingBlock addBlockTag(TagKey<Block> tag)
	{
		TagAdapter.bindStaticTag(tag, this);
		return this;
	}
