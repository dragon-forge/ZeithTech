		...
		implements IRegisterListener, ICustomBlockItem
{
	...
	public HeveaStairBlock(Supplier<BlockState> state, Properties props)
	{
		super(state, props);
	}
	
	public HeveaStairBlock dropsSelf()
	{
		this.dropsSelf = true;
		return this;
	}
	
	public HeveaStairBlock addItemTags(Collection<TagKey<Item>> tags)
	{
		if(itemBlock != null)
			for(var tag : tags)
	...
	public HeveaStairBlock addItemTag(TagKey<Item> tag)
	{
		if(itemBlock != null)
			TagAdapter.bindStaticTag(tag, itemBlock);
		itemTags.add(tag);
	...
	public HeveaStairBlock addBlockTags(Collection<TagKey<Block>> tags)
	{
		for(var tag : tags)
	...
	public HeveaStairBlock addBlockTag(TagKey<Block> tag)
	{
		TagAdapter.bindStaticTag(tag, this);
		return this;
	}
