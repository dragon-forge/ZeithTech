...
public class HeveaFlowerPotBlock
		extends FlowerPotBlock
		implements INoItemBlock
{
	public HeveaFlowerPotBlock(@Nullable Supplier<FlowerPotBlock> emptyPot, Supplier<? extends Block> p_53528_, Properties properties)
	{
