...
public class HeveaWoodButtonBlock
		...
		implements IRegisterListener, ICustomBlockItem
{
	...
	public HeveaWoodButtonBlock(Properties props)
	{
		super(props);
	}
	
	public HeveaWoodButtonBlock dropsSelf()
	{
		this.dropsSelf = true;
		return this;
	}
	
	public HeveaWoodButtonBlock addItemTags(Collection<TagKey<Item>> tags)
	{
		if(itemBlock != null)
			for(var tag : tags)
	...
	public HeveaWoodButtonBlock addItemTag(TagKey<Item> tag)
	{
		if(itemBlock != null)
			TagAdapter.bindStaticTag(tag, itemBlock);
		itemTags.add(tag);
	...
	public HeveaWoodButtonBlock addBlockTags(Collection<TagKey<Block>> tags)
	{
		for(var tag : tags)
	...
	public HeveaWoodButtonBlock addBlockTag(TagKey<Block> tag)
	{
		TagAdapter.bindStaticTag(tag, this);
		return this;
	}
