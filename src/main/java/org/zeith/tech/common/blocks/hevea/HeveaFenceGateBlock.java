...
public class HeveaFenceGateBlock
		...
		implements IRegisterListener, ICustomBlockItem
{
	...
	public HeveaFenceGateBlock(Properties props)
	{
		super(props);
	}
	
	public HeveaFenceGateBlock dropsSelf()
	{
		this.dropsSelf = true;
		return this;
	}
	
	public HeveaFenceGateBlock addItemTags(Collection<TagKey<Item>> tags)
	{
		if(itemBlock != null)
			for(var tag : tags)
	...
	public HeveaFenceGateBlock addItemTag(TagKey<Item> tag)
	{
		if(itemBlock != null)
			TagAdapter.bindStaticTag(tag, itemBlock);
		itemTags.add(tag);
	...
	public HeveaFenceGateBlock addBlockTags(Collection<TagKey<Block>> tags)
	{
		for(var tag : tags)
	...
	public HeveaFenceGateBlock addBlockTag(TagKey<Block> tag)
	{
		TagAdapter.bindStaticTag(tag, this);
		return this;
	}
