		...
		implements IRegisterListener, ICustomBlockItem
{
	...
	public HeveaSlabBlock(Properties props)
	{
		super(props);
	}
	
	public HeveaSlabBlock dropsSelf()
	{
		this.dropsSelf = true;
		return this;
	}
	
	public HeveaSlabBlock addItemTags(Collection<TagKey<Item>> tags)
	{
		if(itemBlock != null)
			for(var tag : tags)
	...
	public HeveaSlabBlock addItemTag(TagKey<Item> tag)
	{
		if(itemBlock != null)
			TagAdapter.bindStaticTag(tag, itemBlock);
		itemTags.add(tag);
	...
	public HeveaSlabBlock addBlockTags(Collection<TagKey<Block>> tags)
	{
		for(var tag : tags)
	...
	public HeveaSlabBlock addBlockTag(TagKey<Block> tag)
	{
		TagAdapter.bindStaticTag(tag, this);
		return this;
	}
