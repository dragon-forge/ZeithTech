...
{
	@RegistryName("boat")
	public static final EntityType<BoatZT> BOAT = EntityType.Builder.<BoatZT> of(BoatZT::new, MobCategory.MISC).sized(1.375F, 0.5625F).clientTrackingRange(10).build("boat");
	...
	public Item getDropItem()
	{
		return switch(this.getBoatTypeZT())
				{
					default -> ItemsZT.HEVEA_BOAT;
					case HEVEA -> ItemsZT.HEVEA_BOAT;
				};
	}
	...
	public enum Type
	{
		HEVEA(BlocksZT.HEVEA_PLANKS, "hevea");
