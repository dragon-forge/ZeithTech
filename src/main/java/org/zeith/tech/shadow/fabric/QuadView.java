...
public interface QuadView
{
     ...
     * @param targetIndex
     * 		Starting position in target array - array must have at least 28 elements available at this
     * 		index.
     * @param isItem
     * 		If true, will output vertex normals. Otherwise will output lightmaps, per Minecraft vertex
     * 		formats for baked models.
     */
     ...
     *
     * @param spriteIndex
     * 		The sprite to be used for the quad. Behavior for {@code spriteIndex > 0} is currently
     * 		undefined.
     * @param sprite
     *        {@link MutableQuadView} does not serialize sprites so the sprite must be provided by the
     * 		caller.
     * @param isItem
     * 		If true, will output vertex normals. Otherwise will output lightmaps, per Minecraft vertex
     * 		formats for baked models.
    ...
    default BakedQuad toBlockBakedQuad()
    {
        ...
        return toBakedQuad(0, finder.find(this, 0), false);
    }
