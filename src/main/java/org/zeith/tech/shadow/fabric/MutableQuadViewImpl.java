...
import static org.zeith.tech.shadow.fabric.EncodingFormat.*;
        ...
        implements QuadEmitter
{
    ...
    @Override
    public final MutableQuadViewImpl fromVanilla(BakedQuad quad, Direction cullFace)
    {
        System.arraycopy(quad.getVertices(), 0, data, baseIndex + HEADER_STRIDE, QUAD_STRIDE);
