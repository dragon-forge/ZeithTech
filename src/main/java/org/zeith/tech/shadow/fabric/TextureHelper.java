 ...
 * {@link #bakeSprite(MutableQuadView, int, TextureAtlasSprite, int)}. Also used by the API itself to implement
...
public class TextureHelper
{
	...
	public static void bakeSprite(MutableQuadView quad, int spriteIndex, TextureAtlasSprite sprite, int bakeFlags)
	{
		if(quad.nominalFace() != null && (MutableQuadView.BAKE_LOCK_UV & bakeFlags) != 0)
		{
			...
			applyModifier(quad, spriteIndex, UVLOCKERS[quad.nominalFace().get3DDataValue()]);
	...
	private static final VertexModifier[] ROTATIONS = new VertexModifier[] {
			null,
			(q, i, t) -> q.sprite(i, t, q.spriteV(i, t), 1 - q.spriteU(i, t)),
			// 90
	...
	static
	{
		UVLOCKERS[Direction.EAST.get3DDataValue()] = (q, i, t) -> q.sprite(i, t, 1 - q.z(i), 1 - q.y(i));
		UVLOCKERS[Direction.WEST.get3DDataValue()] = (q, i, t) -> q.sprite(i, t, q.z(i), 1 - q.y(i));
		UVLOCKERS[Direction.NORTH.get3DDataValue()] = (q, i, t) -> q.sprite(i, t, 1 - q.x(i), 1 - q.y(i));
		UVLOCKERS[Direction.SOUTH.get3DDataValue()] = (q, i, t) -> q.sprite(i, t, q.x(i), 1 - q.y(i));
		UVLOCKERS[Direction.DOWN.get3DDataValue()] = (q, i, t) -> q.sprite(i, t, q.x(i), 1 - q.z(i));
		UVLOCKERS[Direction.UP.get3DDataValue()] = (q, i, t) -> q.sprite(i, t, q.x(i), q.z(i));
	}
}
